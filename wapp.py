...
#            ],
        ...
        if value == 'Brazil':
            ...
            dff = BrazilTable
            latitude = -14.2350 if len(Brazil_derived_virtual_selected_rows) == 0 else dff.loc[Brazil_selected_row_ids[0]].lat
            longitude = -51.9253 if len(Brazil_derived_virtual_selected_rows) == 0 else dff.loc[Brazil_selected_row_ids[0]].lon
